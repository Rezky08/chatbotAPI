            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea name="text" class="textarea"
                        style="resize: none">@isset($question){{ $question->text }}@endisset</textarea>
                </div>
            </div>
            <div class="control has-text-right">
                @if ($method == 'PUT')
                    <button class="button is-primary">Update Question</button>
                @else
                    <button class="button is-primary">Add Question</button>
                @endif
            </div>
        </form>
    </div>
